...
public class TestStarbucks {
	...
	public static void mostrarStarbucks(Starbucks s) {
		...
		System.out.println("conocidoPor: " + s.getConocidoPor());
	...
	public static void testConstructor1(LocalDateTime fechaHora, Genero genero, Integer edad, Ocupacion ocupacion, String servicio,
		...
		try {
			Starbucks s = new Starbucks(fechaHora, genero, edad, ocupacion, servicio,
					 duracion,  valoracion, pedido,  conocidoPor,  satisfecho,  idCliente);	
			mostrarStarbucks(s);
	...
	public static void main(String[] args) {
		...
		Starbucks a1= new Starbucks(LocalDateTime.now(), Genero.Female, 12, Ocupacion.Employed, "Take away", 13, 2.5,pedido ,"Facebook", true,1);
		mostrarStarbucks(a1);
		...
		testConstructor1(LocalDateTime.now(), Genero.Female, 12, Ocupacion.Employed, "Take away", 13, 5.5,pedido ,"Facebook", true,1);
		
		//Caso de prueba fecha mayor que la actual
		System.out.println("====================================");
		System.out.println("Constructor 1 - Caso de prueba fecha mayor que la actual ");
		testConstructor1(LocalDateTime.of(2024,12,3,12,43), Genero.Female, 12, Ocupacion.Employed, "Take away", 13, 5.0,pedido ,"Facebook", true,1);
		
		//Caso de prueba con duracion>60
		System.out.println("====================================");
		System.out.println("Constructor 1 - Caso de prueba con duracion>60 ");
		testConstructor1(LocalDateTime.now(), Genero.Female, 12, Ocupacion.Employed, "Take away", 113, 4.5,pedido ,"Facebook", true,1);
		...
		testConstructor1(LocalDateTime.of(2023,11,3,12,43), Genero.Female, 12, Ocupacion.Employed, "Take away", 13, 5.0,pedido ,"Facebook", true,1);
